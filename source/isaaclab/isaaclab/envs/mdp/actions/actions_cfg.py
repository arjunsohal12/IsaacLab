...
from isaaclab.controllers import DifferentialIKControllerCfg, OperationalSpaceControllerCfg, CuroboControllerCfg
...
@configclass
class CuroboActionCfg(ActionTermCfg):
    ...
    class_type: type[ActionTerm] = task_space_actions.CuroboAction
    ...
    scale: float | tuple[float, ...] = 1.0
    """Scale factor for the action. Defaults to 1.0."""
    controller: CuroboControllerCfg = MISSING
    """The configuration for the differential IK controller."""
