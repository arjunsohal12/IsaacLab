...
from isaaclab.controllers import CuroboControllerCfg
from isaaclab.envs.mdp.actions.actions_cfg import DifferentialInverseKinematicsActionCfg, CuroboActionCfg
...
class FrankaCubeLiftEnvCfg(joint_pos_env_cfg.FrankaCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        self.actions.arm_action = CuroboActionCfg(
            asset_name="robot",
            joint_names=["panda_joint.*"],
            body_name="panda_hand",
            controller=CuroboControllerCfg(command_type="pose", use_relative_mode=False),
            body_offset=CuroboActionCfg.OffsetCfg(pos=[0.0, 0.0, 0.0]),
        )
